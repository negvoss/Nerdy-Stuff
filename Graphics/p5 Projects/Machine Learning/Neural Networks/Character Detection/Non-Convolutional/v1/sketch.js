...
// function preload() {
//   let counter = 0;
//   while (urlExists("training/back/" + counter + ".jpg")) {
//     let img = loadImage("training/back/" + counter + ".jpg");
//     images.push({
//       image:img,
//       output:1
//     });
...
//   }
//   counter = 0;
//   while (urlExists("training/forward/" + counter + ".jpg")) {
//     let img = loadImage("training/forward/" + counter + ".jpg");
//     images.push({
//       image:img,
//       output:0
//     });
...
const setupTrainingData = function() {
  for (let i = 0; i < images.length; i++) {
    ...
    if (images[i].output == 1) { // backslash
      output.matrix[0][0] = 1;
      output.matrix[1][0] = 0;
    } else { // forwardslash
      output.matrix[0][0] = 0;
