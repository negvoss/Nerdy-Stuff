...
function setup() {
  ...
  // urlFileInput = select("#urlFileInput");
  // submitURL = select("#submitURL");
  dropZone = select("#dropZone");
  // submitURL.mousePressed(getImageFromURL);
...
//   console.log(urlFileInput.value());
//   img = loadImage(urlFileInput.value(),"Image failed to load properly",function() {
//     img.loadPixels();
//     resizeCanvas(img.width,img.height);
//     saveHistory(img);
//   });
